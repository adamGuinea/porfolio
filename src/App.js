    ...
    <div id="page" className="scrollspy">
      <header className="header">
        ...
        <section className="section">
          <div
            onMouseLeave={() => setIsTop(!isTop)}
            onMouseEnter={() => setIsTop(!isTop)}
            className="container">
                ...
                <h2 className='sub-header'>
                  ...
                  <slider>
                    <h2 className="word-slider">
                      <span className="ml1">Big fan of</span>
                      &nbsp;
      ...
      <main className="main">
        ...
        <section className="section">
          ...
          <div className="container">
            <div className="content">
              <div className="content-right">
                <h1 className="text-uppercase contact">Contact</h1>
              </div>
              <div className="content-left">
                <div className="content-text">
                  <h2>
                ...
                <div className="content-row details">
                  ...
                  <div className="c-6">
                    <p>
                      ...
                      <em>
                        <a href="/adamGuinea-CV.pdf" download>
                          here
                          </a>
                      </em>
                      .
